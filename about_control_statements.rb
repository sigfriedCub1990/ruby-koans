...
class AboutControlStatements < Neo::Koan
  ...
  def test_while_statement
    ...
    assert_equal 36_288_00, result
  end

  def test_break_statement
    i = 1
    result = 1
    loop do # changed from while true as per Rubocop suggestion
      break unless i <= 10
  ...
  def test_next_statement
    ...
    # Based on https://stackoverflow.com/questions/3029785/declaring-an-integer-range-with-step-1-in-ruby
    assert_equal 1.step(10, 2).to_a, result
  end
