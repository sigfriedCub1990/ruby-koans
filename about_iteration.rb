...
class AboutIteration < Neo::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    even_numbers = array.select(&:even?) # previously { |el| el.even? }
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It works like a `reduce` in other languages, like JS. It takes and initial value
    # and then accumulates the result of invoking the function (+, *, -) on each elements of
    # the Collection.
  end
  ...
  #
  # ANSWER:
  # I know a bit of Ruby so this is a bit unfair, the reason for that is
  # that doing the file reading inside a block ensures that the File is
  # closed when we reach the end of the code block.
  #
